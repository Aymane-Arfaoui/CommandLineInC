...
*
* File:: aymane_arfaoui_HW1_main.c
*
* Description:: The goal of this assignment is to use the command line argument in a C program. The goal is to display the number of arguments from the command line.
*
**************************************************************/
```
